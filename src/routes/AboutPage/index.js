      ...
      <main className="about page content">
        ...
        <div className={cn(s.banner, s.parallax, s.white)}>
          <div>
            ...
            <p className={s.subtitle}>
              <b>почему именно сиродавлена масло и дубовая бочка</b>
            </p>
            <br />
        ...
        <div className="p50 tLeft">
          <p>
            <b> Несколько лет назад нас угостили льняным маслом и она нам очень
            понравилась. </b>
          </p>

          <p>
            Мы по-прежнему много слышали о ее пользе для здоровья, и высокий
            содержание Омега-3.
          </p>
          ...
          <p>
            Но одно дело в том масле немного мешала - легкий привкус горечи.
          </p>
          ...
          <p> Льняное масло куплена в аптеке вообще была ужасно горькой. </p>
          <blockquote>
            <p> &laquo;Она является лекарственная&raquo; - успокаивал себя я. </p>
          </blockquote>
          <p> Но однажды кто-то угостил нас свежеотжатого льняным маслом. </p>

          <blockquote>
            <p> И, &laquo;О, чудо!&raquo; - у нее не было горечи. </p>

            <p> Мы не могли поверить. &laquo;Это точно льняное масло?&raquo; </p>
          </blockquote>

          <p>
            Она была совсем другой - с совершенно чистым вкусом и более сдержанным
            травяным ароматом.
          </p>
        ...
        <h3 className="mTop0"> Открытие №1. Сиродавлену масло нельзя долго хранить </h3>

        <div className="p50 tLeft">

          <p>
            Если льняное масло стоит много дней при комнатной температуре в магазине
            или аптеке - оно полностью прогорклое.
          </p>

          <p>
            Так, на нее дальше написано & quot; холодный отжим, Extra Virgin, срок
            хранения (много) месяцев & quot ;. Но оно уже окисленное.
          </p>
        ...
        <div className="p50 tLeft">
          ...
          <p>
            Знают :) С сильно нагретого льна можно отжать в 2-3 раза больше oлии
            чем из холодного семян. Это большая разница в цене. Они умеют считать
            деньги.
          </p>

        </div>

        <h3> Открытие №3. Все сиродавлени oлии быстро окисляются </h3>

        <div className="p50 tLeft">

        <p>
            Льняное окисляется быстрее всех. но все
            сиродавлени oлии нужно хранить в холодильнике и не более месяца.
            После этого срока они съедобные, но качество уже не та.
        </p>
        <p>
            при
            комнатной температуре через месяц сиродавлени oлии (кроме кокосовой) уже
            горчат.
        </p>
        <p>
            Именно поэтому, промышленно производят <b> рафинированное </b> масло, которое
            можно хранить до 2 лет.
          </p>
        ...
        <div className="p50 tLeft">
          ...
          <p>
            ...
            шнека, при этом неизбежно нагревают зерно. Это - часть процесса их работы.
          </p>
        </div>

        <h3> Открытие №5. Масло немного окисляется от контакта с металлом </h3>
        ...
        <div className="p50 tLeft">
          ...
          <p>
            Хорошую, чистую, натуральную, а не окисленную масло. Но оказалось, что нам даже
            негде ее купить.
          </p>
          <p>
            Мы искали надежного производителя, которому мы могли бы
            доверять, но не нашли.
          </p>
         ...
         <div className={cn(s.banner, s.parallax2, s.white)}>
          <div>
            <h1>Мы выбрали пресс "дубовая бочка"</h1>
            <p className={s.subtitle}>
              Так как в нем семена и не нагреваются и не контактируют с металлом
            </p>
          </div>
        </div>
        ...
        <div className="p50 tLeft">
          ...
          <p>
            Выжимать на этом прессе оказалось нелегко. Но масло действительно выходила сказочно
            хорошая.
          </p>
          ...
          <p>
            И, вот, спустя 2 года, мы открыли этот сайт, на котором вы можете заказать
            отжимания и отправку цеи самой сиродавленои oлии с дубовой бочки.
          </p>

          <p>
            Чтобы сохранить его уникальные качества, сразу после отжима мы
            разливаем его в темные стеклянные бутылки, ставим в холодильник и высылаем
            в тот же день Новой Почтой.
          </p>

          <p>
            Если вы живете во Львове, можем привезти масло вам в Ашана (пр.
            Вячеслава Черновола, 16 и) или в кафе Грин (ул. Братив Рогатынцев, 5).
          </p>

          <p>
            Мы счастливы, что у нас есть возможность поделиться им с вами. И просим, ​​чтобы
            вы заказывали немного заранее, мы не такие большие, и нам нужно хотя-бы
